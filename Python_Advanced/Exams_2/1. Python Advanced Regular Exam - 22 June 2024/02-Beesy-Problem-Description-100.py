...
matrix = []
bee_position = []
energy, total_nectar = 15, 0
is_hive, is_energy_restored = False, False
...
while energy >= 0:
    ...
    if energy == 0 and total_nectar >= 30 and not is_energy_restored:
        energy += abs(total_nectar - 30)
        total_nectar = 30
        is_energy_restored = True
    elif (energy == 0 and total_nectar >= 30 and is_energy_restored) or (energy == 0 and total_nectar < 30):
        break
